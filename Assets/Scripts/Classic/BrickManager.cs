...
public class BrickManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        transform.position = new Vector3(-camera.orthographicSize * camera.aspect + prefabWidth / 2f + padding, camera.orthographicSize - prefabRenderer.bounds.size.y / 2f, transform.position.z);
